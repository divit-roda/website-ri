...
<section class="ketentuan-pengguna-section section-padding">
    <div class="container">
        <div class="section-title">
            <h2>KETENTUAN PENGGUNAAN APLIKASI RODA INDONESIA (RI)</h2>
            <br>
        ...
        <div class="accordion ketentuan-pengguna-arc" id="accordionExample">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample"> 
                    <div class="accordion-body">
                        <ol>
                            ...
                            <p>Ketentuan Penggunaan ini adalah perjanjian antara pengguna (“<b>Anda</b>”) dan PT. Ngaasan Taas Niatean (Brand : Roda Indonesia) (“<b>Kami</b>”), sebuah perseroan terbatas yang didirikan dan beroperasi secara sah berdasarkan hukum negara Republik Indonesia dan berdomisili di Manado, Indonesia. Ketentuan Penggunaan ini mengatur akses dan penggunaan Anda atas aplikasi, situs web (<a href="http://www.rodaindonesia.com">www.rodaindonesia.com</a> dan situs web lain yang Kami kelola), konten dan produk yang disediakan oleh Kami (selanjutnya, secara bersama-sama disebut sebagai “Aplikasi”), serta pemesanan, pembayaran atau penggunaan layanan yang tersedia pada Aplikasi (“Layanan”).</p>
                            <p>
            ...
            <div class="accordion-item my-4">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                    <h5>Akses dan penggunaan Aplikasi tunduk pada Ketentuan Penggunaan ini.</h5>
                        <ol>
                            <li>Anda mempunyai kebebasan penuh untuk memilih menggunakan Aplikasi atau aplikasi lain, menggunakan Layanan yang tersedia pada Aplikasi atau tidak, atau berhenti menggunakan Aplikasi.</li>
                            <li>Kami hanya memfasilitasi Anda untuk menemukan berbagai Layanan yang Anda perlukan dengan menyediakan Aplikasi. Semua Layanan disediakan secara langsung oleh pihak ketiga independen yang setuju menjadi penyedia layanan Kami dengan skema kemitraan atau skema lainnya “Penyedia Layanan”.</li>
                            <li>Ketika memesan Layanan, Aplikasi akan menghubungkan Anda dengan Penyedia Layanan yang tersedia di sekitar lokasi Anda. Dengan demikian, beberapa Layanan tidak dapat digunakan bila Anda tidak mengaktifkan fitur penentuan lokasi.</li>
                            <li>Selanjutnya, jika Penyedia Layanan menerima pesanan Anda, Kami akan menginformasikan status pesanan Anda melalui Aplikasi.</li>
                     <p class="mt-3"></p>
                        </ol>
                    </div>
                </div>
        ...
        <div class="accordion-item my-4">
         ...
         <div class="accordion-item my-4">
                <h2 class="accordion-header" id="headingFour">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">
                        4. Akun Anda
                    </button>
                </h2>
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                            ...
                            <p>
                            Keamanan dan kerahasiaan Akun Anda, termasuk nama terdaftar, alamat surat elektronik terdaftar, nomor telepon genggam terdaftar, rincian pembayaran dan Metode Pembayaran yang Anda pilih, serta kode verifikasi yang dihasilkan dan dikirim oleh sistem Kami atau Penyedia Metode Pembayaran sepenuhnya merupakan tanggung jawab pribadi Anda. Semua kerugian dan risiko yang ada akibat kelalaian Anda menjaga keamanan dan kerahasiaan sebagaimana disebutkan ditanggung oleh Anda sendiri. Dalam hal demikian, Kami akan menganggap setiap penggunaan atau pesanan yang dilakukan melalui Akun Anda sebagai permintaan yang sah dari Anda.</p>
                            <p>
                            Segera beritahukan Kami jika Anda mengetahui atau menduga bahwa Akun Anda telah digunakan tanpa sepengetahuan dan persetujuan Anda. Kami akan melakukan tindakan yang Kami anggap perlu dan dapat Kami lakukan terhadap penggunaan tanpa persetujuan tersebut.</p>
                            <p>
                ...
                <h2 class="accordion-header" id="headingFive">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="true" aria-controls="collapseFive">
                        5. Informasi Pribadi
                    </button>
                </h2>
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                            <p>Pengumpulan, penyimpanan, pengolahan, penggunaan dan pembagian informasi pribadi Anda, seperti nama, alamat surat elektronik, dan nomor telepon genggam Anda yang Anda berikan ketika Anda membuka Akun tunduk pada <a href="?page=kebijakan&sub_page=kebijakan_privasi">Kebijakan Privasi</a>, yang merupakan bagian yang tidak terpisahkan dari Ketentuan Penggunaan ini.
                            </p>
                        </ol>
                    </div>
                </div>
                ...
                <h2 class="accordion-header" id="headingSix">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
                ...
                <h2 class="accordion-header" id="headingSeven">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
                ...
                <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                            <p>Pengunduhan perangkat lunak dan penggunaan Aplikasi adalah bebas biaya. Namun, Kami dapat mengenakan biaya untuk penggunaan fitur tertentu pada Aplikasi di kemudian hari.
                            </p>
                            <p>
                ...
                <h2 class="accordion-header" id="headingEight">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="true" aria-controls="collapseEight">
                ...
                <h2 class="accordion-header" id="headingNine">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
                        9. Kekayaan Intelektual
                    </button>
                </h2>
                <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p>Aplikasi dan Layanan, termasuk namun tidak terbatas pada, nama, logo, kode program, desain, merek dagang, teknologi, basis data, proses dan model bisnis, dilindungi oleh hak cipta, merek, paten dan hak kekayaan intelektual lainnya yang tersedia berdasarkan hukum Republik Indonesia yang terdaftar baik atas nama Kami ataupun afiliasi Kami. Kami (dan pemberi lisensi Kami) memiliki seluruh hak dan kepentingan atas Aplikasi dan Layanan, termasuk seluruh hak kekayaan intelektual terkait dengan seluruh fitur yang terdapat didalamnya dan hak kekayaan intelektual terkait.</p>
                        <p>Tunduk pada Ketentuan Penggunaan ini, Kami memberikan Anda lisensi terbatas yang tidak eksklusif, dapat ditarik kembali, tidak dapat dialihkan (tanpa hak sublisensi) untuk (i) mengunduh, mengakses, dan menggunakan Aplikasi, sebagaimana adanya, hanya pada perangkat berupa telepon genggam dan/atau tablet pribadi Anda dan hanya untuk keperluan terkait penggunaan Layanan, dan (ii) mengakses atau menggunakan konten, informasi dan materi terkait yang tersedia pada Aplikasi hanya untuk kepentingan pribadi dan bukan tujuan komersial. Hak dan hak istimewa lainnya yang tidak secara tegas diberikan dalam Ketentuan Penggunaan ini, adalah hak Kami atau pemberi lisensi Kami.</p>
                        <p>Setiap penggandaan, distribusi, pembuatan karya turunan, penjualan atau penawaran untuk menjual, penampilan baik sebagian atau seluruhnya, serta penggunaan Aplikasi dan/atau Layanan, baik secara digital atau lainnya atau pada perangkat selain telepon genggam atau tablet, termasuk namun tidak terbatas pada penggunaan aplikasi tambahan seperti aplikasi modifikasi, emulator, dan lain-lain, yang menyimpang dari Ketentuan Penggunaan ini, maupun tujuan penggunaan yang ditentukan oleh Kami, merupakan pelanggaran terhadap hak kekayaan intelektual Kami.</p>
                        <p>Anda tidak boleh:</p>
                        <ol>
                        <li>menghapus setiap pemberitahuan hak cipta, merek dagang atau pemberitahuan hak milik lainnya yang terkandung dalam Aplikasi;</li>
                        <li>menyalin, memodifikasi, mengadaptasi, menerjemahkan, membuat karya turunan dari, mendistribusikan, memberikan lisensi, menjual, mengalihkan, menampilkan di muka umum baik sebagian maupun seluruhnya, merekayasa balik (reverse engineer), mentransmisikan, memindahkan, menyiarkan, menguraikan, atau membongkar bagian manapun dari atau dengan cara lain mengeksploitasi Aplikasi (termasuk perangkat lunak, fitur dan Layanan di dalamnya);</li>
                        ...
                        <li>menggunakan dan/atau mengakses secara tidak resmi Aplikasi untuk (a) merusak, melemahkan atau membahayakan setiap aspek dari Aplikasi, Layanan atau sistem dan jaringan terkait, dan/atau (b) membuat produk atau layanan tandingan serupa menggunakan ide, fitur, fungsi atau grafik menyerupai Aplikasi.</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <h2 class="accordion-header" id="headingTen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                ...
                <h2 class="accordion-header" id="headingEleven">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="true" aria-controls="collapseEleven">
                ...
                <h2 class="accordion-header" id="headingTwelve">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwelve" aria-expanded="true" aria-controls="collapseTwelve">
                ...
                <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                        <p>Apabila Anda mengalami gangguan sistem, mengetahui atau menduga bahwa Akun Anda diretas, digunakan atau disalahgunakan oleh pihak lain, atau apabila perangkat telepon genggam atau tablet pribadi Anda hilang, dicuri, diretas atau terkena virus, segera laporkan kepada Kami sehingga Kami dapat segera mengambil tindakan yang diperlukan untuk menghindari penggunaan, penyalahgunaan, atau kerugian yang timbul atau mungkin timbul lebih lanjut.</p>
                        <p>Apabila Anda mengalami kendala atau masalah terkait Layanan, Konten Pihak Ketiga, Penawaran atau pembayaran melalui Metode Pembayaran, atau perlakuan Penyedia Layanan, Penyedia Konten Pihak Ketiga, Penyedia Penawaran atau Penyedia Metode Pembayaran Anda dapat menyampaikan keluhan Anda melalui fitur yang Kami sediakan, termasuk pemberian peringkat dan komentar, atau dengan menghubungi Kami.</p>
                        ...
                        <p>Untuk menanggapi setiap Laporan yang Anda sampaikan, Kami akan melakukan verifikasi terlebih dahulu dengan mencocokan informasi yang Anda berikan dan informasi pribadi Anda yang terdapat dalam sistem Kami. Jika diperlukan, Kami dapat secara langsung meminta Anda memberikan informasi yang diperlukan untuk tujuan verifikasi.</p>
                        <p>Kami dapat menolak untuk menindaklanjuti Laporan Anda jika informasi yang Anda berikan tidak cocok dengan informasi pribadi yang terdapat dalam sistem Kami atau apabila Laporan disampaikan terkait, terhadap, atas nama atau oleh pihak lain yang berbeda dengan pemilik Akun yang bersangkutan yang terdaftar secara resmi pada sistem Kami. Kami dapat memberhentikan tindak lanjut terhadap Laporan Anda jika Kami, dengan kebijakan Kami sepenuhnya, menganggap bahwa Laporan Anda tidak didukung oleh fakta-fakta yang cukup dan jelas, atau telah selesai. Kami juga dapat meneruskan Laporan Anda kepada Penyedia Layanan, Penyedia Konten Pihak Ketiga, Penyedia Penawaran atau Penyedia Metode Pembayaran untuk diselesaikan secara langsung oleh Anda dan Penyedia Layanan, Penyedia Konten Pihak Ketiga, Penyedia Penawaran atau Penyedia Metode Pembayaran.</p>
                        <p>Terhadap Laporan tertentu terkait Layanan, Kami dapat, dengan kebijakan Kami sepenuhnya, memfasilitasi pertemuan antara Anda dan Penyedia Layanan untuk tujuan penyelesaian masalah secara damai dan kekeluargaan. Dalam hal demikian, jika Anda merasa tetap perlu mengambil tindakan lain, termasuk tindakan hukum apapun, Anda dapat melakukannya atas tanggung jawab pribadi Anda sepenuhnya.</p>
                        <p>Terhadap Laporan tertentu terkait Metode Pembayaran, Kami dapat mengembalikan dana Anda melalui cara yang ditentukan oleh Kami atau bersama-sama dengan Penyedia Metode Pembayaran, berdasarkan kebijakan Kami sepenuhnya. Kami tidak akan mengembalikan dana kepada pihak lain yang berbeda dengan kredensial terdaftar pada Akun Roda Indonesia atau Penyedia Metode Pembayaran, termasuk apabila Anda menggunakan kredensial pihak lain untuk melakukan pembayaran melalui Metode Pembayaran.</p>  
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <h2 class="accordion-header" id="headingThirteen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThirteen" aria-expanded="true" aria-controls="collapseThirteen">
                        13. Pembekuan Sementara dan Pembekuan Permanen Akun Roda Indonesia
                    </button>
                </h2>
                <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                        <p>Anda dapat menghapus Aplikasi dari telepon genggam dan/atau tablet Anda setiap saat. Kami tidak memiliki kewajiban apapun kepada Anda terhadap hal-hal yang timbul sejak penghapusan Aplikasi, pembekuan sementara atau pembekuan permanen Akun Anda. Akan tetapi, Anda tetap bertanggung jawab untuk menyelesaikan kewajiban-kewajiban Anda yang telah timbul, termasuk namun tidak terbatas pada, setiap kewajiban yang mungkin timbul akibat adanya sengketa, tuntutan, maupun tindakan hukum lainnya yang telah ada, sebelum tanggal penghapusan Aplikasi, pembekuan sementara atau pembekuan permanen Akun Anda.</p>
                        <p>Akun Anda dapat dibekukan untuk sementara waktu atau dapat dibekukan secara permanen karena hal-hal, termasuk namun tidak terbatas pada, sebagai berikut:</p>
                        <ol>
                        <li>Laporan Anda bahwa Akun Anda digunakan atau diduga digunakan atau disalahgunakan oleh orang lain;</li>
                        <li>Laporan Anda bahwa telepon genggam atau tablet pribadi Anda hilang, dicuri atau diretas;</li>
                        <li>Kami mengetahui atau mempunyai alasan yang cukup untuk menduga bahwa Akun Anda telah dialihkan atau digunakan oleh orang lain;</li>
                        <li>Kami mengetahui atau dengan alasan yang cukup menduga bahwa telah terjadi hal-hal yang menurut pandangan Kami telah atau dapat merugikan Kami, Anda, Penyedia Layanan atau pihak lainnya;</li>
                        <li>Kami mengetahui atau dengan alasan yang cukup menduga bahwa anda telah mendaftar atau masuk dalam banyak Akun dalam satu perangkat untuk tujuan melanggaran Ketentuan Penggunaan, <a href="?page=kebijakan&sub_page=kebijakan_privasi">Kebijakan Privasi</a> atau peraturan dan hukum yang berlaku.</li>
                        <li>Sistem Kami mendeteksi adanya tindakan yang tidak wajar dari penggunaan Akun Anda atau adanya kewajiban berdasarkan Ketentuan Penggunaan, dan/atau Kebijakan Privasi yang tidak dipenuhi oleh Anda;</li>
                        <li>Anda telah meninggal dunia, ditempatkan di bawah perwalian atau pengampuan atau mengalami ketidakmampuan lainnya yang menjadikan Anda tidak cakap hukum berdasarkan peraturan perundang-undangan yang berlaku;</li>
                        <li>Penggunaan Aplikasi atau Layanan oleh Anda atau pihak lain (yang menggunakan Akun Anda) dengan cara yang bertentangan dengan Ketentuan Penggunaan ini, <a href="?page=kebijakan&sub_page=kebijakan_privasi">Kebijakan Privasi</a> atau peraturan perundang-undangan yang berlaku; dan/atau</li>
                        <li>Perintah untuk pembekuan akun, baik sementara atau permanen, yang diterbitkan oleh institusi pemerintah atau moneter terkait atau berdasarkan perintah pengadilan yang diterbitkan sesuai dengan peraturan perundang-undangan yang berlaku.</li>
                        </ol>
                        <p>Jika Akun Anda dibekukan dan Anda memiliki bukti yang jelas bahwa Akun Anda seharusnya tidak dibekukan, Anda dapat membuat Laporan kepada Kami untuk menyampaikan bukti-bukti tersebut. Setelah melakukan pemeriksaan lebih lanjut terhadap Laporan Anda, Kami akan, atas kebijakan Kami sepenuhnya, menentukan untuk mengakhiri atau melanjutkan pembekuan terhadap Akun Anda. Pembekuan tidak akan diteruskan secara tidak wajar apabila Kami memutuskan bahwa hal-hal yang mengakibatkan terjadinya pembekuan telah diselesaikan.</p>
                        <p>Anda tidak akan menggunakan Aplikasi pada perangkat atau sisterm operasi yang telah dimodifikasi diluar perangkat atau konfigurasi sistem operasi dan konfigurasi Roda Indonesia. Hal ini mencakup perangkat yang telah melalui proses “rooted” atau “jail-broken”. Perangkat rooted atau jail-broken adalah perangkat yang telah dibebaskan dari pembatasan yang dikenakan oleh penyedia layanan perangkat dan yang dimanufaktur tanpa persetujuan penyedia layanan perangkat. Penggunaan Aplikasi pada perangkat rooted atau jail-broken dapat mengkompromisasi keamanan dan berujung pada transaksi penipuan.</p>
                        <p>Roda Indonesia tidak bertanggung jawab atas pengunduhan dan penggunaan Aplikasi pada perangkat rooted atau jail-broken dan resiko penggunaan anda terhadap perangkat rooted atau jail-broken sepenuhnya adalah resiko anda. Anda mengerti dan setuju bahwa Roda Indonesia tidak bertanggung jawab atas segala kehilangan atau setiap konsekuensi lain yang diderita atau disebabkan oleh anda sebagai akibat dari penggunaan aplikasi Roda Indonesia pada perangkat rooted atau jail-broken dan Kami mempunyai diskresi untuk menghentikan Penggunaan Anda terhadap Aplikasi pada perangkat rooted atau jail-broken dan memblokirperangkat rooted atau jail-broken untuk menggunakan Aplikasi.</p>  
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <h2 class="accordion-header" id="headingFourteen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFourteen" aria-expanded="true" aria-controls="collapseFourteen">
                ...
                <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <p>Kami akan menindaklanjuti dengan melakukan investigasi dan/atau memfasilitasi Penyedia Layanan yang bersangkutan untuk melaporkan kepada pihak yang berwajib apabila Kami menerima Laporan adanya pelanggaran yang Anda lakukan atas Ketentuan Penggunaan ini ataupun pelanggaran terhadap peraturan perundang-undangan yang berlaku, sehubungan dengan:</p>
                        <ol>
                        <li>Pelecehan atau kekerasan verbal, termasuk namun tidak terbatas pada, atas fisik, jenis kelamin, suku, agama dan ras, yang Anda lakukan terhadap Penyedia Layanan;</li>
                        <li>Tindakan penipuan</li>
                        <li>Penggunaan Aplikasi pada perangkat rooted atau jail-broken;</li>
                        <li>Pelecehan atau kekerasan fisik yang Anda lakukan terhadap Penyedia Layanan; dan/atau</li>
                        <li>Pelecehan atau kekerasan seksual, baik secara verbal maupun fisik, yang Anda lakukan terhadap Penyedia Layanan.</li>
                        </ol>
                        <p>Ketentuan ini juga berlaku sebaliknya apabila Anda mengalami tindakan sebagaimana disebutkan di atas yang dilakukan oleh Penyedia Layanan terhadap Anda.</p>  
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <h2 class="accordion-header" id="headingFifteen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFifteen" aria-expanded="true" aria-controls="collapseFifteen">
                        15. Pernyataan Anda
                    </button>
                </h2>
                <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <p>Dikecualikan dari ketentuan di atas, jika terdapat kerugian langsung akibat pelanggaran Kami terhadap Ketentuan Penggunaan ini, maka Anda setuju dan secara tegas membatasi jumlah tuntutan Anda sebesar jumlah keseluruhan yang senyatanya ditimbulkan atau telah dibayarkan sehubungan dengan peristiwa tersebut.</p>
                        <p>Anda mengakui bahwa kami adalah perusahaan teknologi, bukan perusahaan transportasi, kurir, pos, jasa pengantaran, logistik, keuangan dan lain-lain dan kami tidak memberikan layanan transportasi, kurir, pos, jasa pengantaran, logistik, keuangan dan layanan lain. Semua layanan transportasi, kurir, pos, jasa pengantaran, logistik, keuangan dan layanan lain disediakan pihak ketiga independen yang tidak dipekerjakan oleh kami.</p>
                        <p>Dengan melanjutkan akses atau penggunaan terhadap aplikasi Roda Indonesia dan/atau layanan, anda setuju untuk tunduk dan mematuhi semua ketentuan peraturan perundang-undangan terkait dan ketentuan penggunaan ini, termasuk semua perubahannya dan ketentuan penggunaan dari setiap penyedia layanan, penyedia konten pihak ketiga, penyedia penawaran atau penyedia metode pembayaran. Segera hentikan akses atau penggunaan aplikasi Roda Indonesia dan/atau layanan jika anda tidak setuju dengan bagian apapun dari ketentuan penggunaan ini.</p> 
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <h2 class="accordion-header" id="headingSixteen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixteen" aria-expanded="true" aria-controls="collapseSixteen">
                        16. Keadaan Kahar
                    </button>
                </h2>
                ...
                <h2 class="accordion-header" id="headingSeventeen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeventeen" aria-expanded="true" aria-controls="collapseSeventeen">
                        17. Lain - Lain
                    </button>
                </h2>
                <div id="collapseSeventeen" class="accordion-collapse collapse" aria-labelledby="headingSeventeen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                        <p>Anda mengerti dan setuju bahwa Ketentuan Penggunaan ini merupakan perjanjian dalam bentuk elektronik dan tindakan Anda menekan tombol ‘daftar’ saat pembukaan Akun atau tombol ‘masuk’ saat akan mengakses Akun Anda merupakan persetujuan aktif Anda untuk mengikatkan diri dalam perjanjian dengan Kami sehingga keberlakuan Ketentuan Penggunaan ini dan <a href="?page=kebijakan&sub_page=kebijakan_privasi">Kebijakan Privasi</a> adalah sah dan mengikat secara hukum dan terus berlaku sepanjang penggunaan Aplikasi dan Layanan oleh Anda.</p>
                        <p>Anda tidak akan mengajukan tuntutan atau keberatan apapun terhadap keabsahan dari Ketentuan Penggunaan atau <a href="?page=kebijakan&sub_page=kebijakan_privasi">Kebijakan Privasi</a> yang dibuat dalam bentuk elektronik.</p>
                ...
                <h2 class="accordion-header" id="headingEighteen">
                    <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEighteen" aria-expanded="true" aria-controls="collapseEighteen">
                ...
                <div id="collapseEighteen" class="accordion-collapse collapse" aria-labelledby="headingEighteen" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <ol>
                        <p>Anda dapat menghubungi Kami melalui surat elektronik ke <a href="mailto:cs@rodaindoesia.com">cs@rodaindonesia.com</a> atau melalui telepon ke nomor (0838) 3662 6451. Semua korespondensi Anda akan dicatat, direkam dan disimpan untuk arsip Kami.</p>
                        <p>Saya telah membaca dan mengerti seluruh Ketentuan Penggunaan ini dan konsekuensinya dan dengan ini menerima setiap hak, kewajiban, dan ketentuan yang diatur di dalamnya.</p>
                        <p>dalam ketentuan Pasal 1 angka 3 UU LLAJ, angkutan adalah perpindahan baik orang maupun barang dari satu tempat ke tempat lain dengan menggunakan Kendaraan dalam berlalu lintas di jalan. Kemudian, pada Pasal 1 angka 23 UU LLAJ menyebutkan bahwa yang dimaksud dengan pengangkut, dalam hal ini pengemudi adalah orang yang memiliki SIM (Surat Izin 
                        Mengemudi) serta dapat mengemudikan kendaraan bermotor dalam lalu lintas di jalan. Kewajiban utama pengangkut adalah mengangkut pernumpang dan/atau barang dari suatu tempat ke tempat tujuan tertentu dengan selamat sesuai yang diperjanjikan dalam perjanjian pengangkutannya. Pada Pasal 1 angka 7 Undang- Undang No. 22 Tahun 2009 tentang Lalu Lintas dan Angkutan Jalan, yang dimaksud dengan kendaraan adalah suatu sarana angkut di jalan yang terdiri atas Kendaraan Bermotor dan Kendaraan Tidak Bermotor.
                        </p>
                        <p>Dasar hukum penyelenggaraannya Ojek Online pada pasal 137 ayat (2) UU LLAJ menyatakan bahwa angkutan orang yang menggunakan Kendaraan Bermotor berupa Sepeda Motor, Mobil penumpang, atau bus. Pada Pasal 3 ayat (1) dan ayat (2) Peraturan Pemerintah No. 74 Tahun 2014 tentang Angkutan Jalan menyatakan bahwa sepeda motor merupakan kendaraan bermotor yang dapat mengangkut orang/dan atau barang. Pada Pasal 3 huruf c Peraturan Menteri Perhubungan Republik Indonesia No. 108 Tahun 2017 tentang Penyelenggaraan Angkutan Orang dengan kendaraan Bermotor Umum Tidak dalam Trayek menyatakan bahwa ruang lingkup pengaturan dalam Peraturan Menteri ini meliputi penyelenggaraan Angkutan Orang dengan Kendaraan Bermotor Umum Tidak dalam Trayek dengan Aplikasi berbasis teknologi informasi.  
                        </p>
                        <p>Pada Pasal 3 ayat (1) dan ayat (2) Peraturan Menteri Perhubungan Republik Indonesia No. 12 Tahun 2019 tentang Pelindungan Keselamatan Pengguna Sepeda Motor yang Digunakan Untuk Kepentingan Masyarakat menyatakan bahwa pada intinya sepeda motor dapat digunakan untuk kepentingan masyarakat dengan wajib memenuhi keselamatan, keamanan, kenyamanan, keterjangkauan, dan keteraturan. Dari penjelasan dasar hukum diatas, maka ojek online dapat melakukan proses pengangkutan. Namun, terdapat ketentuan-ketentuan yang mebatasi kegiatan pengangkutan itu. Seperti dalam hal mengangkut barang.</p>
                        </ol>
                    </div>
                </div>
            </div>
