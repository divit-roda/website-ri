        ...
        <div class="row align-items-center text-center">
            <div class="col-12 col-lg-7 text-lg-start">
                <div class="jumbotron-text judul-project">
                    ...
                    <h3>#JalanMenujuPerubahan</h3>
                    <h3>Nganggur...Jangan Dong!</h3>
                </div>
            </div>
...
<section class="rijek-explain section-padding">
    <div class="container mt-100px">
        ...
        <div class="rijek-explain-text mb-5 desc">
            <p>RIBIKE menjadi salah satu alternatif transportasi roda dua berbasis online bagi mereka yg dituntut serba cepat dalam aktifitasnya. Potongan yang lebih layak untuk driver serta diproteksi oleh asuransi adalah bentuk kemitraan kami.
            </p>
        </div>
...
<!-- Fitur RIBIKE -->
        ...
        <div class="project-features px-2 px-md-4 pt-4">
            <div class="list-feature">
                ...
                <p>Pengguna Layanan RIBIKE bisa memilih Type kendaraan sesuai kebutuhan.</p>
            </div>
            <div class="list-feature">
                <i class="info-icon ri-list-ordered"></i>
                <p>Multi order (Max 5 Order dalam waktu bersamaan).</p>
            </div>
            <div class="list-feature">
                <i class="info-icon ri-alert-fill"></i>
                <p>Nama dan Plat nomor Mitra driver tersemat untuk mengidentifikasi jika terjadi kejahatan.</p>
            </div>
            <div class="list-feature">
                <i class="info-icon ri-pin-distance-fill"></i>
                <p>Filter Jarak, memudahkan pengguna layanan RIBKE mendapatkan driver dimanapun berada.</p>
            </div>
            <div class="list-feature">
