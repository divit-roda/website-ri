                    ...
                    <div class="col-md-7 col-lg-4">
                        <div class="bagan-item level-1 line-right d-flex align-items-center">
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>CEO</strong></p></b>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-6 col-lg-3 pe-md-5 pe-lg-4">
                            <div class="bagan-item level-1-5 line-right secertary d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center justify-content-center flex-column">
                                    <p class="tim-section-jabatan"><strong>HR/GA</strong></p></b>
                                    <p class="tim-section-jabatan">...</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-3 ps-md-5 ps-lg-4">
                            <div class="bagan-item level-1-5 line-right legal d-flex align-items-center">
                                <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                                <div class="d-flex align-items-center justify-content-center flex-column">
                                    <p class="tim-section-jabatan"><strong>Legal</strong></p></b>
                                    <p class="tim-section-jabatan">...</p>
                                </div>
                            </div>
                        </div>
                ...
                <ol class="level-3-wrapper">
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Business OPR</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Head Driver</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Coord. Regional</strong></p>...</b>
                            </div>
                        </div>
                    </li>
                </ol>
                ...
                <ol class="level-3-wrapper">
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Front End</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Back End</strong></p>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                ...
                <ol class="level-3-wrapper">
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Public Relation</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Marketing Sales & Dev</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="bagan-item level-3 line-right d-flex align-items-center">
                            <i class="ri-checkbox-blank-circle-fill dot-bagan"></i>
                            <div class="d-flex align-items-center justify-content-center flex-column">
                                <p class="tim-section-jabatan"><strong>Marketing Communication</strong></p></b>
                                <p class="tim-section-jabatan">...</p>
                            </div>
                        </div>
                    </li>
