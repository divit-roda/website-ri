        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 text-center logo-box">
                <div class="jumbotron-img logofitur">
                    ...
                    <img src="assets/logo/ribike_logo_baru.png" alt="logo risend">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="service-features desc">
            <div class="service-feature-item">
                <div class="section-title">
                    <h2>Tata Cara Menjadi <span>Mitra Driver Roda Indonesia</span></h2>
                </div>
                <div class="accordion ketentuan-pengguna-arc" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button btn-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">SELENGKAPNYA</button>
                        </h2>
...
<!-- Modal RIbike -->
<div class="modal fade" id="modalRibike" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header border-danger">
        <h5 class="modal-title" id="exampleModalLabel"><strong>Syarat Pendaftaran RIBike</strong></h5>
...
<!-- Modal RICar -->
<div class="modal fade" id="modalRicar" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header border-danger">
        <h5 class="modal-title" id="exampleModalLabel"><strong>Syarat Pendaftaran RICar</strong></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
       <p>Mendaftar melalui Aplikasi RODA INDONESIA</p>
...
<!-- Modal RISend -->
<div class="modal fade" id="modalRisend" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header border-danger">
    ...
    <div class="modal-body">
      ...
      <ol>
        <li class="my-1">Layanan RISend terdapat beberapa ketentuan berikut:</li>
        <ul>
